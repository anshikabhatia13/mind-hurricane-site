  ...
  return (
    <section id="about" className="about-section reveal">
      ...
      <div className="about-grid">
        <div className="about-card">
          ...
          <p>
            ...
            security, optimizes field operations, and empowers human decision-making.
          </p>
        </div>
      ...
      <div className="about-banner">
        ...
        <p>
          We design cognitive systems — autonomous, adaptive, and built for real-world uncertainty.
        </p>
      </div>

      <div className="about-stats">
        <div><span>3+</span> Years of R&D</div>
        <div><span>5+</span> Field Deployments</div>
        <div><span>2</span> IIT Incubations</div>
        <div><span>3</span> Industry Domains</div>
      </div>
    </section>
  );
}
